...
/// </summary>
public class UserTokensService : IUserTokenService
{
    private static readonly JwtSecurityTokenHandler TokenHandler = new();
    private readonly SymmetricSecurityKey _accessTokenSecurityKey;
    private readonly string _audience;
    private readonly string _issuer;
    private readonly ILogger<UserTokensService> _logger;
    private readonly SymmetricSecurityKey _refreshTokenSecurityKey;

    public UserTokensService(ILogger<UserTokensService> logger)
    {
        _logger = logger;
        // Init secret key
